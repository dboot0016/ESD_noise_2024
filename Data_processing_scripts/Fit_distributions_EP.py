...
# Script for fitting different pointwise distributions for 'Observation based temperature and freshwater noise over the Atlantic Ocean'
...
for method_i in range(len(methods)):
    ...
    if method == 'skewnorm':
        ...
        np.save(dir_era_test+'params_era_ep_genpareto.npy',PARAMS)
        ...
        np.save(dir_era_test+'params_era_ep_johnsonsu.npy',PARAMS)
        ...
        np.save(dir_era_test+'params_era_ep_normal.npy',PARAMS)
        ...
        np.save(dir_era_test+'params_era_ep_nig_test.npy',PARAMS)
    ...
    np.save('std_' + method +'_ep.npy',B)
    np.save('skw_' + method +'_ep.npy',C)
    np.save('kur_' + method +'_ep.npy',D)
